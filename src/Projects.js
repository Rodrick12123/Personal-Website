  ...
  return (
    <div className='projects'>
      <div className='projects_container'>
            ...
            <p>
                ...
                <div className='project_title'>
                    ...
                    <div className='project_contributors'>
                        ...
                        <p>Rodrick Lankford, Jeremy Beckler, Will Flemming, James Berger, Brian Rhee</p>
                    </div>
                </div>
            </p>
        ...
        <a href="https://github.com/Rodrick12123/Artificial-Ecology/tree/main" target="_blank" className='projects_indv'>
            <img src="/eco.PNG" alt="image" />
            <p>
                ...
                <div className='project_title'>
                    ...
                    <div className='project_contributors'>
                        <strong>Contributors: </strong>
                        <p>Rodrick Lankford, Anya Vostinar</p>
                    </div>
                </div>
            </p>
            <div className='languages'>
        ...
        <a href="https://github.com/Rodrick12123/Computer-Graphics" target="_blank" className='projects_indv'>
            <img src="/raster.PNG" alt="image" />
            <p>
                ...
                <div className='project_title'>
                    ...
                    <div className='project_contributors'>
                        <strong>Contributors: </strong>
                        <p>Rodrick Lankford, Josh Davis, Jerimiah Mensah</p>
                    </div>
                </div>
            </p>
            <div className='languages'>
        ...
        <a href='https://github.com/Rodrick12123/World-Cup-Website.github.io' target="_blank" className='projects_indv'>
            ...
            <p>
                <div className='project_title'>
                    ...
                    <div className='project_contributors'>
                        <strong>Contributors: </strong>
                        <p>Rodrick Lankford, Thea Traw</p>
                    </div>
                </div>
        ...
        <a href="https://github.com/Rodrick12123/Artificial-Extinction-Model" target="_blank" className='projects_indv'>
            <img src="/extinct.PNG" alt="image" />
            <p>
        ...
        <a href='https://avenue-application.web.app/' target="_blank" className='projects_indv'>
            <img src="/Talent search.PNG" alt="image" />
            <p>
